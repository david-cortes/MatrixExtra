...
= 74.5GB, but if only 0.01% of the entries are non-zero, can be put down
to \~1.5GB or less), and to perform operations in this sparse
...
(60-70% slower) in this same setup, plus some extra time in the data
